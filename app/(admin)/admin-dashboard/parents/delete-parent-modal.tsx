...
import { useDeleteParent } from "@/hooks/use-parent";
...
export default function DeleteParentModal({
  ...
  const { mutate: deleteParent, error, isPending } = useDeleteParent();

  const handleDelete = () => {
    deleteParent(parentId, {
      onSuccess: () => {
        toast.success("Parent account successfully deleted!", {
          position: "top-right",
          style: {
            "--normal-bg":
