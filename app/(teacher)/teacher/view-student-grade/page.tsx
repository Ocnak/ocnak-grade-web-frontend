...
export default function ViewStudentGrade() {
  ...
  return (
    <section
      className={`${tinos.className} h-screen  bg-[#f9faf8] px-1.5 py-3 text-[#4a4442] antialiased md:p-6`}
    >
      ...
      <div className="flex items-center w-full justify-center">
        <div
          ref={contentRef}
          className="my-5 w-full max-w-full gap-0 overflow-x-hidden border border-gray-200 px-3 py-4 sm:px-4 md:w-221.75 md:rounded-[15px] md:border-gray-300 md:p-6 md:shadow-lg print:border-none print:shadow-none"
        >
